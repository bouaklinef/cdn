 ...
 */
  ...
  require.register("ftlabs~fastclick@v0.6.11", function (exports, module) {
    ...
    function FastClick(layer) {
       ...
       * @type boolean
       */
      this.portalClick = false;

      /**
       * Timestamp for when when click portal started.
       *
       * @type number
       */
      this.portalClickStart = 0;
    ...
    FastClick.prototype.onTouchStart = function (event) {
      ...
      this.portalClick = true;
      this.portalClickStart = event.timeStamp;
    ...
    FastClick.prototype.onTouchMove = function (event) {
      ...
      // If the touch has moved, cancel the click portal
      if (
        this.targetElement !==
    ...
    FastClick.prototype.onTouchEnd = function (event) {
      ...
      portalClickStart = this.portalClickStart;
      this.portalClick = false;
      this.portalClickStart = 0;
      ...
      if (targetTagName === "label") {
        ...
        if (
          event.timeStamp - portalClickStart > 100 ||
          (this.deviceIsIOS &&
            window.top !== window &&
            targetTagName === "input")
        ) {
    ...
    /**
     * On touch cancel, stop portal the click.
     *
     * @returns {void}
     */
    ...
    FastClick.prototype.onClick = function (event) {
      ...
      // It's possible for another FastClick-like library delivered with third-party code to fire a click event before FastClick does (issue #44). In that case, set the click-portal flag back to false and return early. This will cause onTouchEnd to return early.
      if (this.portalClick) {
        this.targetElement = null;
        this.portalClick = false;
        return true;
